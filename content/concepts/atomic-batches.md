...
For assets Kintsugi doesn't auto-discover (vesting positions, LP positions, exotic NFTs), you can compose your own ops with `customCall` from `@kintsugi/core` and place them where they need to be in the array. See the [custom calls](/asset-support/custom-calls/) page.
